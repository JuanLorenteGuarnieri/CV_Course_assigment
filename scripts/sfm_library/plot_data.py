...
if __name__ == "__main__":
  ...
  img1 = cv2.cvtColor(cv2.imread('../../data/raw/buildings/pilar/7.jpg'), cv2.COLOR_BGR2RGB)
...
#carga en x los puntos 2D cada cada camara alojada en processed/.../x_p_opt_i.txt
  ...
  matches = load_and_filter_matches(7, "../../data/processed/buildings/pilar/", max_matches=2000)
  residuals = []
  for i in range(7):
    residuals.append(x[i][:2, :] - matches[i].T[:2, :])
